 ...
 # Notes App 
> The purpose of this app is to gather and display a list of user notes (which can be on any topic or theme, or indeed miscellaneous). 

 ## Installation Instructions 
 - Step 1: Clone the GitHub repository onto your local machine. 
 - Step 2: Navigate to the codebase folder. 
